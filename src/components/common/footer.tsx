            ...
            <div className="lg:col-span-1">
              ...
              <address className="not-italic space-y-3 sm:space-y-4 text-white/75 font-light leading-relaxed">
                ...
                <div className="pt-2">
                  <a
                    href="/call-back"
                    className="inline-block text-white/75 hover:text-[#dbbb90] transition-colors p-0 font-serif text-base font-light tracking-wide uppercase relative group"
                  >
                    Request Call Back
                    <span className="absolute bottom-0 left-0 w-0 h-px bg-[#dbbb90] transition-all duration-300 group-hover:w-full"></span>
                  </a>
                </div>
              </address>
            </div>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-red-500 via-red-600 to-red-700 hover:from-red-600 hover:via-red-700 hover:to-red-800 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg border border-white/10 hover:border-white/30 luxury-hover"
                  aria-label="Gmail"
                >
                  <svg className="w-5 h-5 text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-10 h-10 sm:w-12 sm:h-12 bg-[#E60023] hover:bg-[#D5001F] rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg border border-white/10 hover:border-white/30 luxury-hover"
                ...
                {/* <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-10 h-10 sm:w-12 sm:h-12 bg-[#B92B27] hover:bg-[#A02622] rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg border border-white/10 hover:border-white/30 luxury-hover"
                  aria-label="Quora"
                >
                  <svg className="w-5 h-5 text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-10 h-10 sm:w-12 sm:h-12 bg-[#FFFC00] hover:bg-[#E6E300] rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg border border-white/10 hover:border-white/30 luxury-hover"
                  aria-label="Snapchat"
                >
                ...
                {/* <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-10 h-10 sm:w-12 sm:h-12 bg-black hover:bg-gray-800 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg border border-white/10 hover:border-white/30 luxury-hover"
                  aria-label="TikTok"
                >
                  <svg className="w-5 h-5 text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* LinkedIn */}
                <a
                  href="https://www.linkedin.com/company/theavenuerealestate/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group w-10 h-10 sm:w-12 sm:h-12 bg-[#0077B5] hover:bg-[#006BA1] rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg border border-white/10 hover:border-white/30 luxury-hover"
                  aria-label="LinkedIn"
                >
                  <svg className="w-5 h-5 text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
