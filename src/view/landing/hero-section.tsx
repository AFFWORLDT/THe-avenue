...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[40%] sm:top-28 md:top-32 lg:top-36 xl:top-40 left-1/2 transform -translate-x-1/2 z-30 px-4 sm:px-6 lg:px-8 container w-full max-w-5xl mt-0 sm:mt-6 md:mt-4">
        <motion.div
